...
namespace MonoGameLibrary3D.Graphics
{
    public class Camera3D
    {
        ...
        public void Update(float avatarYaw, Vector3 position, float aspectRatio)
        {
            ...
            ProjectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(GameConstants3D.ViewAngle),
                aspectRatio, GameConstants3D.NearClip, GameConstants3D.FarClip);
        }
    }
}
