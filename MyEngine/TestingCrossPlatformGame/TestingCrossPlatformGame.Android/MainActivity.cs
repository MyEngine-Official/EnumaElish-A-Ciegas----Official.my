...
using TestingCrossPlatformGame.Core;

namespace TestingCrossPlatformGame.Android
{
    /// <summary>
    ...
    /// </remarks>
    [Activity(
        Label = "TestingCrossPlatformGame",
        MainLauncher = true,
        Icon = "@drawable/icon",
    ...
    {
        private TestingCrossPlatformGameGame _game;
        private View _view;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _game = new TestingCrossPlatformGameGame();
