...
namespace TestingCrossPlatformGame.Core.Localization
{
    /// <summary>
    ...
    internal class LocalizationManager
    {
        ...
        public static List<CultureInfo> GetSupportedCultures()
        {
            ...
            ResourceManager resourceManager = new ResourceManager("TestingCrossPlatformGame.Core.Localization.Resources", assembly);
