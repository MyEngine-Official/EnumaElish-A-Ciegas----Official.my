...
using MyEngine.MyPhysics;

namespace MyEngine.MyCore.MyComponents
{
    public class TilemapCollisionsComponent : Tilemap
    {
        ...
        private TilemapCollisionsComponent(Tileset tileset, int columns, int rows) : base(tileset, columns, rows)
        {
        ...
        public static new TilemapCollisionsComponent FromFile(ContentManager content, string filename)
        {
            ...
            using (Stream stream = TitleContainer.OpenStream(filePath))
            {
                using (XmlReader reader = XmlReader.Create(stream))
                {
                    ...
                    TilemapCollisionsComponent collisions = new TilemapCollisionsComponent(tileset, columnCount, rows.Length);
